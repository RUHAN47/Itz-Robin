...
print(logo)
 ...
 print(red+"NASOKOTA CYBER SQUAD") 
~~~~~®~~~~~®~~~~~®~~~~~®
https://github.com/RUHAN47/Itz-Robin
print(green+"Developer by : Md. Shajahan Kabir")                      
~~~~~®~~~~~®~~~~~®~~~~~®
...
manu="""
{acl}[ {ycl}1. {acl}] {gcl}JUST SMS BOMBING⚠️
{acl}[ {ycl}2. {acl}] {gcl}CALL AND SMS BOMBING
{acl}[ {ycl}3. {acl}] {gcl}EMAIL BOMBING
{acl}[ {ycl}4. {acl}] {gcl} Tool's Admin
{acl}[ {ycl}5. {acl}] {gcl}THBD (Logout)
...
try:
  while True:
    ...
    if mao=="1":
      ...
      os.system('xdg-open https://www.facebook.com/md.shajahan.kabir143/')
      break
    elif robin=="5":
      os.system('xdg-open https://www.facebook.com/md.shajahan.kabir143')
      break
